...
# Setup absolute path for templates
...
@app.route("/")
def index():
    # Try multiple common template locations to ensure it works on Render/Linux
    locations = ["index.html", "templates/index.html", "./templates/index.html"]
    ...
    # If all fail, provide a diagnostic error
    cwd = os.getcwd()
    files = os.listdir('.')
    return f"Critical Error: index.html not found. CWD: {cwd}, Files: {files}", 500
